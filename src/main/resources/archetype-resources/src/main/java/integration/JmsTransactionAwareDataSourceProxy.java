...
/**
 * A {@link javax.sql.DataSource} for components that need to participate in a
 * Spring-managed transaction, where there might also be a JMS transaction with
 * a shared resource (the JDBC {@link java.sql.Connection}). Internally the
 * {@link javax.sql.DataSource} proxies its {@link java.sql.Connection} instances and masks off
 ...
 * {@link javax.sql.DataSource} transaction.
 *
 * @author Dave Syer
 *
 */
public class JmsTransactionAwareDataSourceProxy extends TransactionAwareDataSourceProxy {
	...
	/**
	 * Public setter for a {@link org.springframework.jms.core.JmsTemplate} that can be used internally to
	 * synchronize a JMS {@link javax.jms.Session} with an ongoing transaction. This is
	 * not really a {@link javax.sql.DataSource} concern, and should be factored out into
